  ...
  handleResponse(response) {
    ...
    if(typeof response === 'object') {
      if(typeof response.success !== 'undefined') {
        ...
        this.setState({contactRequestErrors: newContactRequestErrors});

      } else if(typeof response.message !== 'undefined') {
        // Anything different from an HTTP response goes here
        this.setState({contactRequestErrors: {name: response.message}});
      }
    }
    ...
    if(recaptcha !== null && recaptcha.current) {
      recaptcha.current.reset();
    }
  }
      ...
      <div className="row">
        <div className="col-lg-12 text-center">
          ...
          <p>
            ...
            {' '}
            you agree the use of your details for future communications
            {' '}
            with yourself in regards to the message.
