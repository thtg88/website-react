        ...
        <div className="row">
            <div className="col-lg-12 text-center">
                ...
                <p className="lead">
                    ...
                    The role granted me the opportunity to attend <a href="#wheres-waldo" onClick={wheresWaldoLinkOnClick}>conferences</a> and events in different countries.
                </p>
                <p className="lead">Outside of the office, you are most likely to find me at a cafè trying to speak a new foreign language, or chasing <a href="#classic-cars" onClick={classicCarsOnClick}>classic cars</a> in the streets of town.</p>
            </div>
        </div>
    </div>
);
