                        ...
                        <div id="contact_request-alert-container" className="form-group">
                            <div className="col-lg-12">
                                <div className="alert alert-danger contact_request-alert" style={{display:(this.state.contactRequestErrors !== null ? 'block' : 'none')}}>
                                    <p>{this.state.contactRequestErrors !== null
                                        && typeof this.state.contactRequestErrors.name !== 'undefined'
                                            ? this.state.contactRequestErrors.name
                                            : ''
                                    }</p>
                                    <p>{this.state.contactRequestErrors !== null
                                        && typeof this.state.contactRequestErrors.email !== 'undefined'
                                            ? this.state.contactRequestErrors.email
                                            : ''
                                    }</p>
                                    <p>{this.state.contactRequestErrors !== null
                                        && typeof this.state.contactRequestErrors.phone !== 'undefined'
                                            ? this.state.contactRequestErrors.phone
                                            : ''
                                    }</p>
                                    <p>{this.state.contactRequestErrors !== null
                                        && typeof this.state.contactRequestErrors.message !== 'undefined'
                                            ? this.state.contactRequestErrors.message
                                            : ''
                                    }</p>
                                    <p>{this.state.contactRequestErrors !== null
                                        && typeof this.state.contactRequestErrors.g_recaptcha_response !== 'undefined'
                                            ? this.state.contactRequestErrors.g_recaptcha_response
                                            : ''
                                    }</p>
                                    <p>{this.state.contactRequestErrors !== null
                                        && typeof this.state.contactRequestErrors['g-recaptcha-response'] !== 'undefined'
                                            ? this.state.contactRequestErrors['g-recaptcha-response']
                                            : ''
                                    }</p>
                                </div>
